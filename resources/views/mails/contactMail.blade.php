<div class="emailBody">
    ...
    <p>We got your enquire request regarding our <a style="color: #c309d2" target="_blank" href="{{ $contact->propertyURL }}">{{
            $contact->propertyURL}}</a> property.</p>
...
<h3 style="color: #000">Here is a copy of what we've got from you</h3>
